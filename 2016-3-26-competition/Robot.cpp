...
//mDashboard(std::make_shared<SmartDashboard4237>())
...
void Robot::RobotInit() {printf("Robot Init\n");}
...
void Robot::OperatorControl() //standard driving and shooter control
{
	...
	{
		//**************************************************************************************
		mRobot->ArcadeDrive(mStick->GetLeftYAxis(), mStick->GetLeftXAxis()); //standard drive
