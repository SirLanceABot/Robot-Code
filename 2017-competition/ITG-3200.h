...
public:
	...
	ITG3200(I2C::Port port, double sensitivity, int deviceAddress = ITG3200_I2C_ADDR, double integrationRate = 0.01, int sampleRate = k1000Hz_10Hz, double initialAngleX = 0, double initialAngleY = 0, double initialAngleZ = 0);
	~ITG3200();
	bool IsWorking();
	void Calibrate();
	void Get();
