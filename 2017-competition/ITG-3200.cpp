...
ITG3200::ITG3200(frc::I2C::Port port, double sensitivity, int deviceAddress, double integrationRate, int sampleRate, double initialAngleX, double initialAngleY, double initialAngleZ)
	:
	mGyro (new frc::I2C(port, deviceAddress)),
