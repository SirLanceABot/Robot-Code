...
class BoilerGripPipeline:
    ...
    def __init__(self):
        ...
        self.__resize_image_0_height = 480.0
        self.__resize_image_0_interpolation = cv2.INTER_CUBIC

        self.resize_image_0_output = None


        self.__resize_image_1_width = 320.0
        self.__resize_image_1_height = 240.0
        self.__resize_image_1_interpolation = cv2.INTER_CUBIC

        self.resize_image_1_output = None

        self.__hsl_threshold_input = self.resize_image_1_output
        self.__hsl_threshold_hue = [49.57017436897938, 157.66187050359713]
        self.__hsl_threshold_saturation = [248.68969231394544, 255.0]
        self.__hsl_threshold_luminance = [74.56890419867494, 179.87373737373736]
    ...
    def process(self, source0):
        ...
        # Step Resize_Image1:
        self.__resize_image_1_input = source0
